    ...
    <div style={{minHeight:"100vh",background:"#0a0f1e",color:"#e2e8f0"}}>
      <nav style={{background:"rgba(255,255,255,0.03)",borderBottom:"1px solid rgba(255,255,255,0.08)",padding:"10px 16px"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:"6px"}}>
          ...
          <Link to="/fees" style={{display:"block",padding:"14px",background:"rgba(99,102,241,0.15)",border:"1px solid rgba(99,102,241,0.3)",borderRadius:"12px",color:"#a5b4fc",textDecoration:"none",textAlign:"center",fontSize:"13px",fontWeight:"bold"}}>🎓 Exam Fees</Link>
