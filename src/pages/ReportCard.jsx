    ...
    <div style={{minHeight:"100vh",background:"#0a0f1e",color:"#e2e8f0"}}>
      ...
      <div style={{maxWidth:"1100px",margin:"0 auto",padding:"12px"}}>
        <div style={{background:"linear-gradient(135deg,#0d1b3e,#1a3a6e)",padding:"14px",textAlign:"center",borderRadius:"10px 10px 0 0",borderBottom:"3px solid #eab308"}}>
          <h1 style={{color:"#eab308",fontSize:"18px",margin:"0 0 2px",fontWeight:"bold",letterSpacing:"2px"}}>SUNRISE COLLEGE</h1>
          ...
          <h2 style={{color:"#fff",fontSize:"13px",margin:"0",fontWeight:"bold",letterSpacing:"1px"}}>STUDENT REPORT CARD / BULLETIN DE NOTES</h2>
        ...
        <div style={{background:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.08)",borderTop:"none",padding:"10px 14px",display:"grid",gridTemplateColumns:"1fr 1fr",gap:"6px",marginBottom:"10px"}}>
          ...
          <div>
            ...
            <p style={{fontSize:"11px",color:"#94a3b8",margin:"0 0 3px"}}>DOB / Date de Naissance: <strong style={{color:"#fff"}}>{student.dateOfBirth||"-"}</strong></p>
        ...
        <div style={{overflowX:"auto",marginBottom:"10px"}}>
          <table style={{width:"100%",borderCollapse:"collapse"}}>
            <thead>
              <tr>
                <th style={{...th,textAlign:"left",minWidth:"160px"}}>Subject / Matiere</th>
                ...
                <th style={{...th,background:"rgba(16,185,129,0.12)",minWidth:"100px"}}>Remark/Appreciation</th>
              </tr>
            </thead>
            <tbody>
              {subjects.map((subj,i)=>{
            ...
            <tfoot>
              <tr style={{background:"rgba(234,179,8,0.08)",fontWeight:"bold"}}>
                <td style={{...td,textAlign:"left",color:"#eab308",fontWeight:"bold"}}>OVERALL AVERAGE / MOYENNE GENERALE</td>
                {SEQUENCES.map(s=><td key={s} style={td}></td>)}
                <td style={td}></td><td style={td}></td><td style={td}></td>
                <td style={{...td,color:"#eab308",fontSize:"13px",fontWeight:"bold"}}>{overall||"-"}</td>
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:"10px",marginBottom:"10px"}}>
          {[{en:"Principal Signature",fr:"Signature du Directeur"},{en:"Class Teacher",fr:"Prof. Principal"},{en:"Parent / Guardian",fr:"Parent / Tuteur"}].map((l,i)=>(
            <div key={i} style={{background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.07)",borderRadius:"8px",padding:"10px",textAlign:"center"}}>
              <p style={{fontSize:"10px",color:"#64748b",margin:"0 0 2px"}}>{l.en}</p>
              <p style={{fontSize:"9px",color:"#475569",margin:"0 0 8px"}}>{l.fr}</p>
              <div style={{height:"30px",borderBottom:"1px solid rgba(255,255,255,0.1)"}}></div>
            </div>
          ))}
        </div>
        <p style={{textAlign:"center",fontSize:"9px",color:"#334155"}}>Powered by ReportCard Pro — Suh Ebook Empire</p>
      </div>
    </div>
  );
}
